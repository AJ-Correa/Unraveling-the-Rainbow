...
from network.mlp import MLPActor
...
class HGNNScheduler(nn.Module):
    ...
    def get_action_prob(self, state, memories, flag_sample=False, flag_train=False):
        ...
        return action_probs, ope_step_batch
    ...
    def act(self, state, memories, dones, epsilon=None, flag_sample=True, flag_train=True):
        ...
        action_probs, ope_step_batch = self.get_action_prob(state, memories, flag_sample, flag_train=flag_train)
...
class REINFORCE:
    ...
    def update(self, memory, env_paras, train_paras):
        ...
        for i in range(num_complete_minibatches + 1):
            ...
            policy_loss = -(logprobs * rewards_envs[start_idx:end_idx])
